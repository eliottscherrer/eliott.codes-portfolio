...
- UI built on accessible, unstyled Radix UI Primitives for custom UI, with a fully static export

### CI/CD & Deployment

- Automated GitHub Actions workflow that lints and builds every pull request, then triggers a Dokploy deployment on my VPS
- Dokploy spins up a preview environment for each pull request, on its own subdomain
